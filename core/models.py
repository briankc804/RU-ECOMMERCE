...
class Category(models.Model):
    ...
    def category_image(self):
        return mark_safe('<ig src="%s" width="50" height="50">' % (self.image.url))
...
class Vendor(models.Model):
    ...
    title = models.CharField(max_length=100, default="Namor")
...
class CartOrderItems(models.Model):
    ...
    def order_img(self):
        return mark_safe('<ig src="/media/%s" width="50" height="50">' % (self.image))
